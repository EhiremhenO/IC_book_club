...
import { idlFactory } from './ic_book_club_backend.did.js';
export { idlFactory } from './ic_book_club_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IC_BOOK_CLUB_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic_book_club_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic_book_club_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic_book_club_backend.did.js")._SERVICE>}
 */
export const ic_book_club_backend = createActor(canisterId);
